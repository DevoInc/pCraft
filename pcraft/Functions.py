...
class Functions:
    def __init__(self, plugins_data, functionsdir=None):
        self.loaded_functions = {}
        self.instdir = str(pathlib.Path(__file__).parent.absolute())
        if functionsdir == None:
            functionsdir = self.instdir + "/functions/"
        ...
        for modfile in self.functions:
            ...
            import_function = "pcraft" + import_function[len(self.instdir):]
