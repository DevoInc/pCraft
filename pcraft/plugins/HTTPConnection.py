...
"""
    ...
    def run(self, script=None):
        ...
        httpget_string = "{method} {uri} HTTP/1.1\r\nAccept: */*\r\nUser-Agent: {useragent}\r\nHost:{host}\r\nContent-Length:{contentlen}\r\nConnection: Keep-Alive\r\nCache-Control: no-cache\r\n\r\n{content}".format(method=script["method"], uri=script["uri"], useragent=script["user-agent"], host= self.plugins_data._get("domain"),contentlen=122, content=str(os.urandom(122)))
