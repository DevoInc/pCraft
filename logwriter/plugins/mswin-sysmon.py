...
class LogPlugin(LogContext):
    ...
    def __init__(self, outpath):
        ...
        self.log_fp = self.openlog("mswin_sysmon.log")

    def __del__(self):
        self.closelog()

    def validate_keys(self, kvdict):
        self.do_validate_keys("microsoft.windows.sysmon.logstash14", kvdict["event_id"], kvdict)
    ...
    def template_to_log(self, frame_time, kvdict):
        ...
        event = self.retrieve_template("microsoft.windows.sysmon.%s" % (log_flavor), kvdict["event_id"], kvdict)
